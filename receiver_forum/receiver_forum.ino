...
const byte Address[6] = "NODE1"; /* Address from which data to be received */
...
{
char bufferData[25];                    /* Variable to store received data */
radio.read(&bufferData, sizeof(bufferData));/* Read the received data and store in ' rx_data ' */
Serial.print("Received Data : ");
Serial.println(bufferData);           /* Print received value on Serial Monitor */
